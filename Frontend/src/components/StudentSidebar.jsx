    ...
    <div>
      ...
      <nav className="w-64 bg-white h-screen sticky top-0 p-4">
        ...
        <ul className="space-y-2">
          ...
          <li>
            <NavLink
              to="/Student_dashboard/leaderboard"
              className={({ isActive }) =>
                `flex items-center py-3 px-6 rounded-2xl transition-colors duration-200 ${
                  isActive ? 'bg-black text-white' : 'hover:bg-gray-200'
                }`
            ...
            >
              <FaUsers className="mr-2" /> Leaderboard
            </NavLink>
          </li>
          <li>
            <NavLink
              to="/Student_dashboard/my_activity"
              className={({ isActive }) =>
                `flex items-center py-3 px-6 rounded-2xl transition-colors duration-200 ${
                  isActive ? 'bg-black text-white' : 'hover:bg-gray-200'
                }`
            ...
            >
              <FaCalendarAlt className="mr-2" /> My Activity
            </NavLink>
          </li>
          <li>
            <NavLink
              to="/Student_dashboard/notification"
              className={({ isActive }) =>
                `flex items-center py-3 px-6 rounded-2xl transition-colors duration-200 ${
                  isActive ? 'bg-black text-white' : 'hover:bg-gray-200'
                }`
            ...
            >
              <FaEnvelope className="mr-2" /> Notification
            </NavLink>
          </li>
          <li>
            <NavLink
              to="/Student_dashboard/settings"
              className={({ isActive }) =>
                `flex items-center py-3 px-6 rounded-2xl transition-colors duration-200 ${
                  isActive ? 'bg-black text-white' : 'hover:bg-gray-200'
                }`
